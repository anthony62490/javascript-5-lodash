...
{
  return _.reduce(purchasesByMonth[month], function(sum, month){
    return sum + month.price;
  }, 0);
}

// const value = purchasesByMonth.month
const totalByMonth = [];
for(i in purchasesByMonth)
{
  console.log(i);
  let val = reduceMonth(i);
  // let results= {i : val}
  totalByMonth.push({[i]: val});
}
